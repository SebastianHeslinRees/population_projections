...
config_list <- list(projection_name = projection_name,
                    ...
                    #rates
                    mortality_rates = paste0(data_dir, "processed/mortality_rates.rds"),
                    fertility_rates = paste0(data_dir, "processed/fertility_rates.rds"),
                    ...
                    communal_est_path = paste0(data_dir, "processed/lonLUTI_communal_establishment_popn.rds"),
                    dwellings_to_households_path = paste0(data_dir, "processed/lonLUTI_dwelling_2_hh_ratio.rds"),
...
create_excel(config_list$output_dir, "NUTS2 Lower lonLUTI.xlsx", "Test")
