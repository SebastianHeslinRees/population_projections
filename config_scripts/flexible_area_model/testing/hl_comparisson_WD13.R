...
projection_name <- "comparisson_New"
...
config_list <- list(projection_name = projection_name,
                    ...
                    #rates
                    mortality_rates = paste0(data_dir, "processed/mortality_rates_4yr_avg_WD13CD.rds"),
                    fertility_rates = paste0(data_dir, "processed/fertility_rates_4yr_avg_WD13CD_4yr.rds"),
