...
projection_name <- "2021_SHLAA_dev_15yr"

#Constraints
constraint_list <- list(constraint_path = "outputs/trend/2021/2021_15yr_22-12-13_1417/",
...
#Migration
in_migration <- list(
  '2022' = list(path = paste0(data_dir, "processed/in_migration_flows_WD22CD_15yr_avg.rds"),
                transition = F))

out_migration <- list(
  '2022' = list(path = paste0(data_dir, "processed/out_migration_rates_WD22CD_15yr_avg.rds"),
                transition = F))
