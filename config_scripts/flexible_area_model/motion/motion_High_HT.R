#High variant, Housing Targets

data_dir <- "input_data/flexible_area_model/"
projection_name <- "motion_High_housing_targets"

#Constraints
constraint_list <- list(constraint_path = "outputs/trend/2020/2020_HC_high_21-09-21_1259/",
