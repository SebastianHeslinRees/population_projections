#Central International, Central Domestic
#Very high int out
...
first_proj_yr <- 2020
n_proj_yr <- 10
projection_name <- "2019_variant_CC_v_high_int_out"
...
int_out_flows_rates <- list('2020' = list(path = "input_data/mye/2019/int_out_5yr_avg_flow_2019.rds",
                                          transition = F),
                            '2022' = list(path = "input_data/mye/2019/int_out_5yr_avg_flow_2019.rds",
                                          transition = T),
