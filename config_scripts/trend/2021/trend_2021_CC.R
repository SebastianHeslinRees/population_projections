...
projection_name <- "2021_CC_central_upper"
standard_covid_migration <- TRUE

#-------------------------------------------------------------------------------

int_out_flows_rates <- list(
  '2025' = list(path = "input_data/scenario_data/2021_int_out_10yr_avg.rds",
                transition = F))
...
domestic_rates <- list(
  '2025' = list(path = "input_data/scenario_data/2021_dom_10yr_avg.rds",
                transition = F))
