...
first_proj_yr <- 2020
n_proj_yr <- 8
projection_name <- "2019_variant_CC_BPO"
...
int_out_flows_rates <- list('2020' = list(path = "input_data/scenario_data/international_10yr_out_flows.rds",
                                          transition = F),
                            '2021' = list(path = "input_data/scenario_data/int_out_flow_covid_2020.rds",
                                          transition = F),
                            '2022' = list(path = "input_data/scenario_data/int_out_flow_covid_2020.rds",
                                          transition = T),
