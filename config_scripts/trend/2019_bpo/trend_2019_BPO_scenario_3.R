...
first_proj_yr <- 2020
n_proj_yr <- 31
projection_name <- "2019_BPO_scenario_3"
...
int_out_flows_rates <- list('2020' = list(path = "input_data/scenario_data/bpo_int_out_scenario_1_yr_2020.rds",
                                          transition = F),
                            '2021' = list(path = "input_data/scenario_data/bpo_int_out_scenario_3_yr_2021.rds",
                                          transition = F),
...
int_in  <- list('2020' = list(path = "input_data/scenario_data/bpo_int_in_scenario_1_yr_2020.rds",
                ...
                '2021' = list(path = "input_data/scenario_data/bpo_int_in_scenario_1_yr_2021.rds",
                              transition = F),
                '2022' = list(path = "input_data/scenario_data/bpo_int_in_scenario_3_yr_2022.rds",
                              transition = T),
