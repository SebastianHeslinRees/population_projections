...
first_proj_yr <- 2020
n_proj_yr <- 31
projection_name <- "2019_short_constrained"
...
int_in_flows  <- list('2020' = list(path = paste0(int_flows_loc,"int_in_5yr_avg_2019.rds"),
                              transition = F))
...
domestic_rates <- list('2020' = list(path = paste0(dom_rates_loc,"dom_rates_5yr_avg_2019.rds"),
                                     transition = F))
