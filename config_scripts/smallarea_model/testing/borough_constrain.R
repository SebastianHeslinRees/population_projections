...
projection_name <- "housing-led_2013_borough_constraining"
...
constraint_list <- list(constraint_path = "outputs/trend/2020/2019_comparisson_22-01-31_1033/",
                        ...
                        components = list(births = F,
                                          ...
                                          out_migration = F,
                                          population = T),
                        lookup_path = "input_data/smallarea_model/lookups/borough_level_constraining.rds")
...
config_list <- list(projection_name = projection_name,
                    first_proj_yr = 2020,
                    n_proj_yr = 22,
                    output_dir = paste0("outputs/smallarea_model/", projection_name),
