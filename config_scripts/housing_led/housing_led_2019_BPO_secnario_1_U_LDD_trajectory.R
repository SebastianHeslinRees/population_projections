...
external_trend_path <- "outputs/trend/2019/2019_BPO_scenario_1_21-03-09_1459/"

projection_name <- "BPO_scenario_1_U_LDD"
...
dev_trajectory_path <- "input_data/housing_led_model/trajectory_based_on_LDD_average.rds"
