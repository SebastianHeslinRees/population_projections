...
# get the input data
source("model_code/model_builds/ml_housing_led/01_get_inputs.R")
...
# test the input data
source("model_code/model_builds/ml_housing_led/02_test_inputs.R")
...
# run the model
source("model_code/model_builds/ml_housing_led/03_core.R")
projection <- ml_housing_led(start_popn, fertility, mortality, development, ahs, n_proj_yr)

# write the output data
source("model_code/model_builds/ml_housing_led/04_output.R") # Should this be a shared module? 
