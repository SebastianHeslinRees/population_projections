...
test_that("deaths_from_popn_mort creates the expected output", {
  expect_equal(deaths_from_popn_mort(pop, mort, col_aggregation = "area", col_count = "count", col_rate = "rate", col_deaths = "deaths"),
               deaths,
               check.attributes=FALSE)
  expect_equal(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("age","area","sex"), col_count = "count", col_rate = "rate", col_deaths = "deaths"),
               deaths2,
               check.attributes=FALSE)
})
...
test_that("deaths_from_popn_mort handles factors, tibbles and groups", {
  ...
  expect_equal(deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_count = "count", col_rate = "rate", col_deaths = "deaths"),
               deaths_out,
               check.attributes=FALSE)
  expect_equal(deaths_from_popn_mort(pop, mort_in, col_aggregation = "area", col_count = "count", col_rate = "rate", col_deaths = "deaths"),
               deaths,
               check.attributes=FALSE)
