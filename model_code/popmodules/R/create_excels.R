...
#'
#' If a projection has been run with the \code{write_excel} varibale set to \code{FALSE}
#' and the Excel outputs are subsequently required this function will produce those workbooks.
#' Creates a population workbook, an ONS household workbook and a DCLG household worknook.
#'
#' @param dir String. The output directory where the projection RDS files are saved
#' @param stamp String. The time stamp on the output RDS file names format \code{%y-%m-%d_%H%M} 
#' @param file_name String. File name for the population workbook ouput. Must include \code{.xslx} suffix.
#'   
#' @example create_excels(dir = "outputs/trend/2018/2018_long/",
#' stamp = "19-11-13_2144",
