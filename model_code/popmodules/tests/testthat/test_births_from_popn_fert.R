...
# example inputs
popn        <- expand.grid( year = 2000, gss_code=c("a","b"), age=20:21, sex=c("female","male"), count = 205, stringsAsFactors = FALSE)
popn_no_age <- expand.grid( year = 2000, gss_code=c("a","b"),            sex=c("female","male"), count = 410, stringsAsFactors = FALSE)
