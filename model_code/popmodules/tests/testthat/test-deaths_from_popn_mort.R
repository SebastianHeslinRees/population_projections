...
test_that("deaths_from_popn_mort creates the expected output", {
  expect_equivalent(deaths_from_popn_mort(pop, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths)
  expect_equivalent(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("age","area","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths2)
})

test_that("deaths_from_popn_mort can work with mortality at a coarser resolution than the population", {
  expect_equivalent(deaths_from_popn_mort(pop2, mort, col_aggregation = c("age", "area", "sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths2)
})

test_that("deaths_from_popn_mort fails when there's more than one death rate for each aggregation level", {
  expect_error(deaths_from_popn_mort(pop, mort2, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
})
...
test_that("deaths_from_popn_mort doesn't care about the order of aggregation columns and throws errors if there are duplicates", {
  expect_equivalent(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("area","age","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths2)

  expect_error(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("area","age","sex","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
  expect_error(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("area"="age","area","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
  expect_error(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("area"="age","age","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
})
...
test_that("deaths_from_popn_mort handles additional, unused input columns", {
  ...
  expect_equivalent(deaths_from_popn_mort(pop_in, mort_in, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths)
})
...
test_that("deaths_from_popn_mort handles factors, tibbles and groups", {
  ...
  expect_equivalent(deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths_out)
  expect_equivalent(deaths_from_popn_mort(pop, mort_in, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths)
...
test_that("deaths_from_popn_mort warns when factor levels don't match the input", {
  ...
  expect_warning( temp <- deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths") )
  expect_equivalent(temp, deaths) # due to differing factor levels, the output won't have a factor in the area column

  expect_warning( temp <- deaths_from_popn_mort(pop, mort_in, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths") )
...
test_that("deaths_from_popn_mort handles mappings between column names in the population and mortality data frames", {
  ...
  expect_equivalent(deaths_from_popn_mort(pop_in, mort2, col_aggregation = c("xage"="age","xarea"="area","xsex"="sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"),
                    deaths2)
})
...
test_that("deaths_from_popn_mort warns when the input already has a deaths column and throws an error when it's an aggregation level", {
  ...
  expect_warning(temp <- deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths") )
  expect_equivalent(temp, deaths)
  expect_error(deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "area") )
})
...
test_that("deaths_from_popn_mort handles important data column names duplicated between the population and mortality data", {
  ...
  expect_warning(temp <- deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "value", col_rate = "rate", col_deaths = "value"))
  expect_equivalent(temp,  deaths_out)

  expect_equivalent(deaths_from_popn_mort(pop, mort_in, col_aggregation = "area", col_popn = "popn", col_rate = "value", col_deaths = "value"),
                    deaths_out)

  expect_warning(temp <- deaths_from_popn_mort(pop_in, mort_in, col_aggregation = "area", col_popn = "value", col_rate = "value", col_deaths = "value"))
  expect_equivalent(temp, deaths_out)

  pop_in <- dplyr::rename(pop, value = area)
  expect_error(deaths_from_popn_mort(pop_in, mort_in, col_aggregation = c("value"="area"), col_popn = "popn", col_rate = "value", col_deaths = "deaths"))
})
...
test_that("deaths_from_popn_mort handles unused columns in the inputs with column names from the other inputs", {
  ...
  expect_warning(temp <- deaths_from_popn_mort(pop, mort_in, col_aggregation = c("area"="xarea"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
  expect_equivalent(temp, deaths)
})
...
test_that("deaths_from_popn_mort throws an error with explicit missing aggregation values", {
  ...
  expect_error(deaths_from_popn_mort(pop_in, mort, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
  expect_error(deaths_from_popn_mort(pop, mort_in, col_aggregation = "area", col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
})
...
test_that("deaths_from_popn_mort throws an error with implicit missing aggregation values", {
  ...
  pop_in <- pop2[-1,]
  expect_error(deaths_from_popn_mort(pop_in, mort2, col_aggregation = c("age","area","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
})


test_that("deaths_from_popn_mort throws an error with duplicate aggregation values", {
  expect_error(deaths_from_popn_mort(pop2, mort2, col_aggregation = c("area","sex"), col_popn = "popn", col_rate = "rate", col_deaths = "deaths"))
})
