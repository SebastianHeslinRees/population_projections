...
births_mye_path <-  "input_data/test_data/births_test.rds"
int_in_mye_path <-  "input_data/test_data/int_in_test.rds"
int_out_mye_path <-  "input_data/test_data/int_out_test.rds"
dom_out_mye_path <- "input_data/test_data/dom_out_test.rds"
dom_in_mye_path <- "input_data/test_data/dom_in_test.rds"
dom_origin_destination_path <- "input_data/test_data/dom_flows_test.rds"

mortality_curve_filepath <- "input_data/test_data/mort_curve_test.rds"
...
popn_constraint_path <- "input_data/test_data/test_pop_constraint.rds"
births_constraint_path <- "input_data/test_data/test_birth_constraint.rds"
deaths_constraint_path <- "input_data/test_data/test_death_constraint.rds"
int_in_constraint_path <- "input_data/test_data/test_int_in_constraint.rds"
int_out_constraint_path <- "input_data/test_data/test_int_out_constraint.rds"
cross_in_constraint_path <- "input_data/test_data/test_cross_in_constraint.rds"
cross_out_constraint_path <- "input_data/test_data/test_cross_out_constraint.rds"

ons_stage1_file_path <- "input_data/test_data/ons_stage1_test.rds"
ons_stage2_file_path <-  "input_data/test_data/ons_stage2_test.rds"
communal_est_pop_path <- "input_data/test_data/communal_est_pop_test.rds"
dclg_stage1_file_path <- "input_data/test_data/dclg_stage1_test.rds"
dclg_stage2_file_path <- "input_data/test_data/dclg_stage2_test.rds"
