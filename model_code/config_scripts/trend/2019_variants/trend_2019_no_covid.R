...
first_proj_yr <- 2020
n_proj_yr <- 31
projection_name <- "2019_variant_no_covid"
...
int_in  <- list('2020' = list(path = "input_data/scenario_data/international_10yr_in_flows.rds",
                              transition = F))
...
domestic_rates <- list('2020' = list(path = paste0(dom_rates_loc,"dom_rates_10yr_avg_2019_gla_mye.rds"),
                                     transition = F))
