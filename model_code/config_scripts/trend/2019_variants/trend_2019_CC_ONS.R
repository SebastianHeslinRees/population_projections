#Central International, Central Domestic, ONS components
...
first_proj_yr <- 2020
n_proj_yr <- 31
projection_name <- "2019_variant_CC_ONS"
...
fertility_rates <- "input_data/fertility/fert_rates_5yr_trend_2019.rds"
...
int_out_flows_rates <- list('2020' = list(path = "input_data/scenario_data/int_out_flow_covid_2020.rds",
                            ...
                            '2022' = list(path = "input_data/scenario_data/int_out_flow_covid_2021_22.rds",
                                          transition = T),
                            '2028' = list(path = "input_data/mye/2019/int_out_10yr_avg_flow_2019.rds",
                                          transition = F))
...
int_in  <- list('2020' = list(path = "input_data/scenario_data/int_in_covid_2020.rds",
                ...
                '2022' = list(path = "input_data/scenario_data/int_in_covid_2021_22.rds",
                              transition = T),
                '2028' = list(path = "input_data/mye/2019/int_in_10yr_avg_2019.rds",
                              transition = F))
...
domestic_rates <- list('2020' = list(path = "input_data/scenario_data/dom_covid_70_percent.rds",
                       ...
                       '2022' = list(path = "input_data/scenario_data/dom_covid_70_percent.rds",
                                     transition = T),
                       '2028' = list(path = "input_data/domestic_migration/processed_rates/dom_rates_10yr_avg_2019.rds",
                                     transition = F))
