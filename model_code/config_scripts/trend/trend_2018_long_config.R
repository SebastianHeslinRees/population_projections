...
int_in  <- list('2019' = list(path = paste0(int_flows_loc,"int_in_15yr_avg_2018.rds"),
                              transition = FALSE))
...
domestic_rates <- list('2019' = list(path = paste0(dom_rates_loc,"dom_rates_15yr_avg_2018.rds"),
                                     transition = FALSE))
