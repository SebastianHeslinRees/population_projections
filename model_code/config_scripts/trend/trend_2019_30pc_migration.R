...
first_proj_yr <- 2020
n_proj_yr <- 31
projection_name <- "interim_2019_30percent_scenario"
...
domestic_rates <- list('2020' = list(path = "input_data/domestic_migration/processed_rates/dom_rates_10yr_avg_2019_30pc.rds", transition = T),
                       '2025' = list(path = "input_data/domestic_migration/processed_rates/dom_rates_10yr_avg_2019.rds", transition = F))
