...
domestic_rates <- list('2019' = list(path = "input_data/domestic_migration/2018/domestic_rates_10yr_avg.rds", transition = T),
                       '2024' = list(path = "input_data/domestic_migration/2018/domestic_rates_2009.rds", transition = F))
