...
mortality_fns <- list(
  ...
  list(fn = popmodules::scaled_mortality_curve, args = list(popn_mye_path = popn_mye_path,
                                                            ...
                                                            data_col = "deaths",
                                                            output_col = "rate",
                                                            project_rate_from = first_proj_yr)),
  ...
  int_in  <- list('2012' = list(path = paste0(int_flows_loc,"int_in_10yr_avg_2019_70pc.rds"),
                                transition = F),
                  '2021' = list(path = paste0(int_flows_loc,"int_in_10yr_avg_2019_50pc.rds"),
                                transition = T),
                  '2024' = list(path = paste0(int_flows_loc,"int_in_10yr_avg_2019_80pc.rds"),
                                transition = F))
  ...
  domestic_rates <- list('2012' = list(path = paste0(dom_rates_loc,"dom_rates_10yr_avg_2019_70pc.rds"),
                                       transition = F),
