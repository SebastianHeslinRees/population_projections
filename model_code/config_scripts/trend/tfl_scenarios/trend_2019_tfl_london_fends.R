# TfL scenario projection - London fends for itself
...
int_in  <- list('2020' = list(path = paste0(int_flows_loc,"int_in_10yr_avg_2019_70pc.rds"),
                              transition = F),
                '2021' = list(path = paste0(int_flows_loc,"int_in_10yr_avg_2019_30pc.rds"),
                              transition = T),
                '2026' = list(path = paste0(int_flows_loc,"int_in_pre_accession_reduced_ldn_share.rds"),
                              transition = F))
...
domestic_rates <- list('2020' = list(path = paste0(dom_rates_loc,"dom_rates_10yr_avg_2019_70pc.rds"),
                                     transition = F),
                       '2021' = list(path = paste0(dom_rates_loc,"dom_rates_10yr_avg_2019_30pc.rds"),
                                     transition = T),
                       '2026' = list(path = paste0(dom_rates_loc,"dom_rates_10yr_avg_2019_reduced_ldn_in.rds"),
                                     transition = F))
