...
These projections are interim projections. We anticipate the projection will be updated later in 2023 following ONS revisions to the 2021 mid-year estimate and the release of additional 2021 census data.
...
These 2021-based projections are interim projection while we await the release of additional 2021 census datasets and updates to the 2021 Mid-year Estimate (MYE) and the MYE backseries for the period 2012-2020.  
...
The size of the working age population (16-64) in London is heavily dependent on the level of migration. High net out migration as seen in the *5-year trend* Population variant leads to a decline in the working age population over time. In the *15-year trend* Population variant, which has a low net out migration, the population grows over the period to 2050.
