...
first_proj_yr <- 2019
n_proj_yr <- 20
popn_mye_path <- "input_data/mye/2018/population_ons_2019-07-30.rds"
deaths_mye_path <- "input_data/mye/2018/deaths_ons_2019-07-30.rds"
births_mye_path <- "input_data/mye/2018/births_ons_2019-07-30.rds"
...
rm(first_proj_yr, n_proj_yr, popn_mye_path, deaths_mye_path, outputs_dir, mortality_fns, qa_areas_of_interest, timestamp)
