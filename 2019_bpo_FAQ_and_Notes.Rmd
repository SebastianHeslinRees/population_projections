...
int_in_10yr_avg_2019 <- readRDS("input_data/mye/2019/int_in_10yr_avg_2019.rds")
int_out_10yr_avg_2019 <- readRDS("input_data/mye/2019/int_out_10yr_avg_flow_2019.rds")
...
births_ons <- readRDS("input_data/mye/2019/births_ons.rds") %>% 
  filter_ldn() %>% 
  group_by(year) %>% 
...
s1_path <- "outputs/housing_led/2019/BPO_scenario_1_21-03-24_1820/"
s2_path <- "outputs/housing_led/2019/BPO_scenario_2_21-03-24_1820/"
s3_path <- "outputs/housing_led/2019/BPO_scenario_3_21-03-24_1820/"
...
### Births data
Mid-year estimate births are available up to and including the year to mid-2019. Births for 2020 are estimated based on GP registrations data. Births for 2021 and years following are calculated by applying projected fertility rates to the population at single-year-of-age.
...
births_ons <- rbind(births_ons, data.frame(year = 2020, births = 115040))
...
births_ons %>% 
  ...
  layout(title = "Total births (2002-2020), London",
         ...
         annotations = list(
           list(x = 1,
                y = -0.10, #position of text adjust as needed 
                text = "Source: ONS Mid-year Estimates (2002-2019), GLA predicted (2020)", 
                showarrow = F,
                xref='paper',
                yref='paper', 
                xanchor='right',
