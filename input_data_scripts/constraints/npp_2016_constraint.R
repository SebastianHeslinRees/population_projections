...
message('2016-based NPP constraints')
...
for(i in 1:4){
  ...
  #population
  population[[i]] <- data.table::fread(paste0(npp_location,"npp_2016_population_",country_suffix[[i]],".csv")) %>%
  ...
  cross_border_in[[i]] <- mig_constraints(paste0("npp_2016_cross_border_",country_suffix[[i]],".csv"), "cross_in", "In", country_id[[i]])
  cross_border_out[[i]] <- mig_constraints(paste0("npp_2016_cross_border_",country_suffix[[i]],".csv"), "cross_out", "Out", country_id[[i]])
  international_in[[i]] <- mig_constraints(paste0("npp_2016_international_",country_suffix[[i]],".csv"), "int_in", "In", country_id[[i]])
  international_out[[i]] <- mig_constraints(paste0("npp_2016_international_",country_suffix[[i]],".csv"), "int_out", "Out", country_id[[i]])
}
