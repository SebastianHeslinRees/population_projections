...
message("fertility rates 2019-based model")
...
saveRDS(average_5yrs, "input_data/fertility/fert_rates_5yr_avg_2019_gla_mye.rds")
saveRDS(trend_5yrs, "input_data/fertility/fert_rates_5yr_trend_2019_gla_mye.rds")
saveRDS(trend_5yrs_LOW, "input_data/fertility/fert_rates_5yr_trend_2019_gla_mye_LOW.rds")
