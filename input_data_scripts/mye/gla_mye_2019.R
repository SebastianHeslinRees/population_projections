...
ons_int_out <- readRDS("input_data/mye/2019/int_out_ons.rds")
...
#save
saveRDS(popn, "input_data/mye/2019/population_gla.rds")
saveRDS(int_in, "input_data/mye/2019/int_in_gla.rds")
saveRDS(int_out, "input_data/mye/2019/int_out_gla.rds")
