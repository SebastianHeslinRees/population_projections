...
message("Ward 2022 Household model")
...
lsoa_ward_lookup <- readRDS(paste0(input_data_dir, "lookups/lsoa_to_WD22_lookup_best_fit.rds"))
...
# Do the same for 2020 wards
# This time save the output for use in the model
