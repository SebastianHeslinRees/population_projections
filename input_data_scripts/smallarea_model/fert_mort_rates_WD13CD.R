...
mort_rates_4 <- scaled_mortality_curve(popn = ward_pop,
                                     births = ward_births,
                                     deaths = ward_deaths,
                                     target_curves = "input_data/mortality/ons_asmr_curves_2018_(2021_geog).rds",
                                     last_data_year = 2019,
...
fert_rates_4 <- scaled_fertility_curve(popn = ward_pop,
                                     births = ward_births,
                                     target_curves = "input_data/fertility/ons_asfr_curves_2018_(2021_geog).rds",
                                     last_data_year = 2019,
                                     n_years_to_avg = 4,
...
saveRDS(mort_rates_4, paste0(input_data_dir, "processed/mortality_rates_4yr_trend_WD13CD.rds"))
saveRDS(fert_rates_4,  paste0(input_data_dir, "processed/fertility_rates_4yr_trend_WD13CD.rds"))
