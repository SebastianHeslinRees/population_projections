...
message("mortality rates 2020-based model")
...
deaths_mye_path <-  paste0("input_data/mye/2020/deaths_ons.rds")
...
saveRDS(average_5yrs, "input_data/mortality/mort_rates_5yr_avg_2020.rds")
...
# #--- Save
# 
# saveRDS(average_5yrs, "input_data/mortality/mort_rates_5yr_avg_2020_gla_mye.rds")
# saveRDS(trend_5yrs, "input_data/mortality/mort_rates_5yr_trend_2020_gla_mye.rds")
# 
# rm(list = ls())